...
public class Cart_Fragment_Adapter extends RecyclerView.Adapter<Cart_Fragment_Adapter.ViewHolder>{
    Context context;
    ArrayList<home_fragment_model> arrlist;
    int raw_id;
    Cart_Fragment_Adapter(Context context, ArrayList<home_fragment_model> arrlist,int raw_id){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btn_remove_cart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                ButtonClickHandler.removeFromCart("?p_id="+arrlist.get(position).p_id, context);
            }
        });
        holder.btn_desc_cart.setOnClickListener(new View.OnClickListener(
        ) {
            @Override
            public void onClick(View v) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View view) {
            ...
            btn_desc_cart=view.findViewById(R.id.btn_desc_cart);
            btn_remove_cart=view.findViewById(R.id.btn_remove_cart);
        }
    }
}
